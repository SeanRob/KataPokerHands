...
public class KataPokerHands {
     ...
     */
    public KataPokerHands(String hands) {
    ...
    public static void main(String args[]) {
        ...
        System.out.println(new KataPokerHands(hands).getResult());
    }
        ...
        switch (combo.name) {
            ...
            case FullHouse:
                ...
                for (Card card : hand.cards) {
                    if (card.cardType.value == pairValue) {
                        continue;
                    }
    ...
    public class Hand implements Comparable<Hand> {
        ...
        /**
         * Three cards have the same value and the remaining two share the same
         * value.
         */
    ...
    public static class Card implements Comparable<Card> {
        ...
        public int compareTo(Card other) {
            if (this.cardType.value == other.cardType.value) {
                return 0;
            }
    ...
    public enum Suit {
        ...
        /**
         * Return a Suit from a single character of the starting suit.
         *
    ...
    public enum CardType {
        ...
        /**
         * Return a CardType from a single character.
         *
